    ...
    <main class="main">
        <section class="section">
            <form method="GET" action="">
                <label for="days" hidden>Select overdue days:</label>
                ...
                <input type="hidden" name="days" placeholder="Custom days" min="1" oninput="this.form.submit()" class="form-control" value="<?php echo $days; ?>">
            </form>

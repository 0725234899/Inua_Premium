...
INNER JOIN borrowers ON loan_applications.borrower = borrowers.id 
WHERE repayments.repayment_date < CURDATE()
AND borrowers.loan_officer = ?";  // Fixed reference to loan_officer

$stmt_overdue = $conn->prepare($sql_overdue); // ✅ First prepare the statement
$stmt_overdue->bind_param("s", $email); // ✅ Then bind parameters
...
<head>
    ...
    <title>Loan Officer Dashboard - Microfinance</title>
...
<div class="sidebar" id="sidebar">
    <div class="sidebar-header">
        ...
        <h5 class="mt-2">Loan Officer Portal</h5>
    </div>
...
<main class="main">
    <div class="container">
        <div class="dashboard-header">
            ...
            <p class="welcome-text">Welcome back! Here's an overview of your portfolio performance.</p>
        </div>
                    ...
                    <tbody>
                        ...
                        if ($result_due->num_rows > 0) {
                            while($row = $result_due->fetch_assoc()) {
                                ...
                                $today = new DateTime();
                                $days_difference = $today->diff($due_date)->days;
                                $status_class = '';
                                $status_text = '';
                                ...
                                echo '<tr>
                                    ...
                                    <td>KSH ' . number_format($row['total_amount_paid'], 2) . '</td>
